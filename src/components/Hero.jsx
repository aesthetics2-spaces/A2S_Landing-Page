...
const Hero = () => {
  ...
  /* Rotate headings and images every 5s */
  useEffect(() => {
  ...
  return (
    <section className="relative min-h-[110vh] md:min-h-screen flex items-center justify-center px-6 bg-gradient-to-br from-light via-white to-primary/10 overflow-y-hidden">
      
      {/* Background Images with fade effect - Stack all images */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        {images.map((img, i) => (
          <motion.div
            ...
            animate={{ 
              opacity: i === index ? 1 : 0,
              transition: { duration: 1.5, delay: i === index ? 0 : 0 }
            }}
            exit={{ opacity: 0 }}
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-white/30 via-transparent to-white/20 z-10" />
      </div>

      {/* Pattern overlay */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgba(0,0,0,0.04)_1px,transparent_0)] bg-[size:24px_24px] opacity-20 z-20" />

      <div className="max-w-4xl text-center space-y-8 md:space-y-10 z-30 relative">
        {/* Badge */}
        <motion.div
          ...
          className="inline-block px-4 py-1 text-sm rounded-full bg-white/80 backdrop-blur border border-primary/20 text-primary shadow-sm"
        >
        ...
        <motion.p
          ...
          className="text-base md:text-lg text-gray-800 max-w-2xl mx-auto backdrop-blur-sm bg-white/30 px-4 py-2 rounded-lg"
        >
        ...
        >
          {[
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              className="bg-white/90 backdrop-blur border border-white/30 rounded-xl px-3 sm:px-6 py-3 min-w-[60px] sm:min-w-[90px] shadow-lg"
            >
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto w-full">
          <motion.input
            ...
            className="flex-1 px-4 py-3 rounded-xl border border-white/30 outline-none focus:ring-2 focus:ring-primary/30 w-full bg-white/90 backdrop-blur shadow-sm"
          />
          <motion.button
            initial={{ x: 60, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
